                ...
                <div class="row">
                    <div class="col">
                        <div class="page-description">
                            <h1>
                                <a href="{{ route('user.reports') }}" class="back-link">
                ...
                <div class="row">
                    ...
                    @if ($report->submission)
                        ...
                        <form id="delete-form-{{ $report->submission->id }}"
                            action="{{ route('user.reports.delete', $report->submission->id) }}" method="POST"
                    ...
                    @else
                        <div id="dropzone">
                            <form action="{{ route('user.reports.submit', $report->id) }}" class="dropzone needsclick"
